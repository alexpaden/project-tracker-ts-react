...
const BugsDetailsPage = () => {
  ...
  const bug = useSelector((state: RootState) =>
    selectBugById(state, projectId ? projectId : '', bugId ? bugId : '')
  )
  ...
  const handleDeleteBug = () => {
    dispatch(deleteBug(projectId ? projectId : '', bugId ? bugId : ''))
    navigate(`/projects/${projectId}`)
  }

  const handleCloseBug = () => {
    dispatch(
      closeReopenBug(projectId ? projectId : '', bugId ? bugId : '', 'close')
    )
  }

  const handleReopenBug = () => {
    dispatch(
      closeReopenBug(projectId ? projectId : '', bugId ? bugId : '', 'reopen')
    )
  }
